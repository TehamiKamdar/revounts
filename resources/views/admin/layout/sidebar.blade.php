<nav class="sidebar sidebar-offcanvas dynamic-active-class-disabled" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('revounts_cms.index') }}">
        ...
        <li class="nav-item ">
            ...
            <div class="collapse " id="createstore">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('revounts_cms.store-index') }}">All Stores</a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#coupon" aria-expanded="" aria-controls="coupon">
                <i class="menu-icon mdi mdi-dna"></i>
        ...
        <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#review" aria-expanded="" aria-controls="review">
                <i class="menu-icon mdi mdi-dna"></i>
        ...
        <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#blog" aria-expanded="" aria-controls="blog">
                <i class="menu-icon mdi mdi-dna"></i>
        ...
        <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#storecategory" aria-expanded="" aria-controls="blog">
                <i class="menu-icon mdi mdi-dna"></i>
                <span class="menu-title">Category</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse " id="storecategory">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#user-pages" aria-expanded=""
            ...
            <div class="collapse" id="user-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item ['user-pages/login']) }}">
                        <a class="nav-link" href="{{ url('/user-pages/login') }}">Login</a>
                    </li>
                    <li class="nav-item ['user-pages/register']) }}">
                        <a class="nav-link" href="{{ url('/user-pages/register') }}">Register</a>
                    </li>
                    <li class="nav-item ['user-pages/lock-screen']) }}">
