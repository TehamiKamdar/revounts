...
@section('content')
    <div class="hero-section">
        <div class="container">
            <h1>Reviews</h1>
            <p class="lead mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam ratione nihil, blanditiis
                harum fugiat et nemo provident optio itaque quas maiores sit illum minus quasi officiis magni ab corrupti.
                Aperiam!</p>
        </div>
    </div>
                    ...
                    <div class="all-reviews-list">
                        ...
                        <div class="review-card" data-rating="5" data-date="today">
                            <div class="review-card-header">
                                <a href="{{ route('review.details', 'ultrabook-pro-laptop') }}"
                                    class="review-product">UltraBook
                                    Pro Laptop</a>
                            ...
                            <p class="review-text">Best laptop I've ever owned. The battery life is incredible and
                                performance
                        ...
                        <div class="review-card" data-rating="4" data-date="yesterday">
                            ...
                            <p class="review-text">Great sound quality and battery life. Noise cancellation works well but
                                could
                        ...
                        <div class="review-card" data-rating="3" data-date="3days">
                            ...
                            <p class="review-text">Heart rate monitor is inaccurate during workouts. Sleep tracking works
                                well
                        ...
                        <div class="review-card" data-rating="2" data-date="1week">
                            ...
                            <p class="review-text">Bass is weak and Bluetooth connectivity drops frequently. Expected better
                                for
                                this price range.</p>
                            <div class="review-footer">
                                <div class="reviewer">
