                        		...
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-12">
											...
											<form class="form-horizontal" method="post"  enctype="multipart/form-data"  name="author_form">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" name="author_url"   class="form-control" >
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <textarea type="text" class="summernote" value=""  name="author_desc" ></textarea>
	                                                </div>
	                                            </div>
											   ...
											   <div class="form-group">
												 ...
												 <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control"  name="author_title" value="">
	                                                </div>
	                                            </div>
												 ...
												 <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" name="author_meta_desc" value="">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
                                                   ...
                                                   <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" id="keywords" name="quora" value="">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" id="keywords" name="email" value="">
	                                                </div>
	                                            </div>
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Contact</label>
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" id="keywords" name="contact" value="">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                   <button type="button" onclick="addAuthor()" class="btn btn-purple waves-effect waves-light">Save</button>
