                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-12">
                        					<form class="form-horizontal" role="form" enctype="multipart/form-data" id="reviewform"  name="review_form">  
	                                          ...
	                                          <div class="form-group">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" value="" name="r_slug">
	                                                </div>
	                                            </div>
	                                           ...
	                                           <div class="form-group">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                   <button type="button" onclick="add_review()" id="save_btn" class="btn btn-purple waves-effect waves-light">Submit</button>
...
<?php } else { 
header('location: '.constant_url.'revounts_cms');
}
?>
