                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-12">
                        					<form class="form-horizontal" role="form" enctype="multipart/form-data" id="blogform"  name="blog_form">                                    
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" value="" name="b_slug" oncontextmenu="return false;" onkeyup="nametourl();" id="slugText">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
														  ...
														  <textarea type="text" id="sum" class="summernote" value="" name="b_short_description" ></textarea>
	                                                </div>
	                                            </div>
											   <div class="form-group">
	                                                <label class="col-md-2 control-label">Long Description</label>
	                                                <div class="col-md-10">
	                                                    <textarea type="text" class="summernote" value="" name="b_long_description" ></textarea>
	                                                </div>
	                                            </div>
	                                           ...
	                                           <div class="form-group">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                   <button type="button" onclick="add_blog()" class="btn btn-purple waves-effect waves-light">Submit</button>
							...
							<a href="#custom-modal"  id="blog_response" data-animation="door" data-plugin="custommodal" data-overlaySpeed="100" data-overlayColor="#36404a"></a>
                        			<!--	<div class="col-md-6">
