			...
			<div class="content-page">
				...
				<div class="content">
					<div class="container">
						...
						$select="select * from tblblogpost_draft where id='".$_GET['blog_id']."'";
						$con=db_connect();
                        			...
                        			<div class="row">
                        				<div class="col-md-12">
                        					<form class="form-horizontal" role="form" enctype="multipart/form-data" id="blogform"  name="blog_edit_form"> 
											 ...
											 <input type="hidden" name="draft_blog" value="<?php echo $rows['id'] ?>">		
...
.admin-custom-ul li {
    ...
    list-style-type: none;
	                                                ...
	                                                <div> <ul class="admin-custom-ul">
	                                                    <strong>Editor Styling Tool:</strong>
                <li><a href="https://www.revounts.com.au/seo/tools/blog-editor.php?type=product-1" target="_blank">Products Showcase #1</a></li>
                <li><a href="https://www.revounts.com.au/seo/tools/blog-editor.php?type=product-2" target="_blank">Products Showcase #2</a></li>
                <li><a href="https://www.revounts.com.au/seo/tools/blog-editor.php?type=product-3" target="_blank">Products Showcase #3</a></li>
                <li><a href="https://www.revounts.com.au/seo/tools/blog-editor.php" target="_blank">All Styling</a></li>
            </ul></div>
	                                            </div>
	                                            ...
	                                            <select class="form-control select2" id="cat" name="b_category">
												 ...
												 <label class="col-md-2 control-label">Select Store</label>
	                                                <div class="col-md-10"> 
                                                                ...
                                                                <select name="r_store" type="text" class="form-control" >
																<?php echo store_name($rows['r_store']); ?>		
											...
											<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="checkbox" name="is_draft" id="is_draft"  value="1"  data-plugin="switchery"  checked  data-color="#81c868">
	                                                </div>
	                                            </div>
