                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Total Networks On Your Website:<span class="label label-pink" id="t_network"><?php echo total_network(); ?></span></b></h4>
                            <h3 id="status_response_network"></h3>
...
$('#datatable-buttons).load().fadeIn("slow");
