...
define('url','http://revounts.com.au/');
...
function edit_store_form($id)
{
		...
		?>
						<div class="col-md-12">
                                                        <a style="display:none;" href="javascript:void(0)" class="btn btn-primary" onclick="delete_store(<?php echo $rows['id'] ?>)">Delete Store</a>
											...
											<form class="form-horizontal" method="post"  enctype="multipart/form-data"  name="store_edit_form">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" name="update_store_url" onkeyup="nametourl()" id="s_slug"  class="form-control" value="<?php echo $rows['store_url'] ?>" readonly>
	                                                </div>
	                                            </div>
                                                <div class="form-group">
	                                           ...
	                                           <div class="form-group">
	                                            ...
	                                            <div class="form-group">
												 ...
												 <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" id="title" name="meta_title" value="<?php  echo $rows['meta'] ?>">
	                                                </div>
	                                            </div>
												 <div class="form-group">
	                                                <label class="col-md-2 control-label">Meta Description</label>
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" id="desc" name="meta_desc" value="<?php  echo $rows['meta_des'] ?>">
	                                                </div>
	                                            </div>
                                                    <div class="form-group">
	                                                <label class="col-md-2 control-label">AMP Meta Description</label>
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" id="desc" name="meta_desc_amp" value="<?php  echo $rows['amp_meta_desc'] ?>">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Android App Link</label>
	                                                <div class="col-md-10">
												...
												<div class="form-group">
	                                                <label class="col-md-2 control-label">IOS App Link</label>
	                                                <div class="col-md-10">
                                        ...
                                        <div class="modal-dialog"> 
                                            <div class="modal-content"> 
                                                <div class="modal-header"> 
                                                    ...
                                                    <h4 class="modal-title">Edit Category: <?php echo $rows['name']; ?></h4>
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input type="text" class="form-control"  name="update_tracking_url" value="<?php echo $rows['tracking_url']; ?>"  placeholder="Tracking Url"> 
                                                            </div> 
                                                        </div> 
                                                    </div>
