...
$path = '../../images/review/'; // upload directory 
 ...
 (`slug`, `store_id`, `short_desc`,`long_desc`, `img`, `img_alt`, `country`, `meta_title`, `meta_desc`, `date`, `views`, `featured`, `timestamp`)
 VALUES 
 ("'.$slug.'",
 "'.$_POST['r_store'].'",
...
$path = '../../images/blog/'; // upload directory	
 ...
 (`name`, `short_des`, `long_des`, `image`, `image_alt`, `tags`, `meta_title`, `meta_des`, `category`, `featured`,`status`,publish_date,name_your,`url`,`views`)
 VALUES 
