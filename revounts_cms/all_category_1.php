                        		...
                        		<div class="card-box">
                        			...
                        			<div class="row">
                    				    ...
                    				    <form class="form-horizontal" role="form" name="editCat_form" method="post">
                                            ...
                                            <input type="hidden"  name="cat_form_value"/> 
                                            <input type="hidden"  name="queryString" value="<?php echo $_SERVER['QUERY_STRING'] ?>"/>
                                              ...
                                              <div class="form-group">
                                                  <label class="col-md-2 control-label">Edit Category</label>
                                                  <div class="col-md-10">
                                                     <input type="button" onclick="cat_form()" id="save_btn" class="btn btn-purple waves-effect waves-light" value="Submit">
