...
<title>CartinCoupon Sort Coupons Instantly </title>
...
<table class="table" width="100%">
            ...
            <tbody id="sortThis">
            <?php
			$allRecords = mysql_query("select * from tblcoupon where season_active='1' and season='".$_GET['season']."' ORDER BY sort asc");
