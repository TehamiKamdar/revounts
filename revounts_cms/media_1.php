				...
				<div class="content">
					<div class="container">
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title"><b>Media</b></h4>
                        			...
                        			<div class="row">
                        				<div class="col-md-12">
											...
											<form class="form-horizontal" method="post"  enctype="multipart/form-data"  name="media_form">

												<input type="hidden" name="username" value="admin">
												
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Add Image For</label>
	                                                <div class="col-md-2">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-2">
	                                                    <input type="file" class="filestyle" name="media_image" data-iconname="fa fa-cloud-upload">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                   <button type="button" onclick="add_image()" class="btn btn-purple waves-effect waves-light">Save</button>
