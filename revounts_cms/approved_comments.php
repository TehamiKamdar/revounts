...
<head>
    ...
    <link href="https://www.myfirstsaving.com/css/animate.css" rel="stylesheet" type="text/css"/>
...
<div id="custom-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="full-width-modalLabel" aria-hidden="true" style="display: none;">

</div><!-- /.modal -->			
				
<button id="modal_btn"  data-toggle="modal" data-target="#custom-modal" style="display:none;"></button>
<script>
