			...
			<div class="content-page">
				...
				<div class="content">
					<div class="container">
						...
						$select="select * from review_draft where id='".$_GET['review_id']."'";
						$con=db_connect();
                        				...
                        				<div class="col-md-12">
                        					<form class="form-horizontal" role="form" enctype="multipart/form-data" id="reviewform"  name="review_edit_form"> 
											 <input type="hidden" name="review_id" value="<?php echo $rows['id'] ?>">		
	                                                    <input type="hidden" class="form-control" value="<?php echo $rows['id'] ?>" name="draft_review">
	                                                    <input type="hidden" class="form-control" value="<?php echo $rows['img'] ?>" name="old_image">
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" value="<?php echo $rows['slug'] ?>" name="r_slug">
	                                                </div>
	                                            </div>
											...
											<?php } ?>
											  ...
											  <div class="form-group">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                   <button type="button" onclick="edit_review_draft()" class="btn btn-purple waves-effect waves-light">Submit</button>
